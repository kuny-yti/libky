...
///< 编译器屏障
#define kyCompilerBarrier()	__asm__ __volatile__("": : :"memory")
...
#    define kyMemoryBarrierReadOnlySMP()	smp_mb()
#    define kyMemoryBarrierWriteOnlySMP()	dmb(ishst)
#  endif

///< 其他架构时若编译器为GCC或Clang时采用GCC的方式
#elif kyCompiler == kyCompiler_GNUC || kyCompiler == kyCompiler_CLANG
