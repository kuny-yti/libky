...
template< typename T , typename Alloc>
typename ky_linked<T, Alloc>::iterator ky_linked<T, Alloc>::insert(size_t pos, const T& val)
{
    detach();
...
template< typename T , typename Alloc>
void ky_linked<T, Alloc>::insert(size_t pos, const ky_linked<T, Alloc>& val)
{
...
template< typename T , typename Alloc>
#if kyLanguage < kyLanguage11
void ky_linked<T, Alloc>::insert(iterator itr, size_t n, const T &x )
{
    iterator i = itr;
    forever (n--)
        i = insert(i, x);
...
#else
typename ky_linked<T, Alloc>::iterator ky_linked<T, Alloc>::insert(const_iterator itr, size_t n, const T &x )
{
    iterator i = itr;
    forever (n--)
        i = insert(i, x);
...
template< typename T , typename Alloc>
size_t ky_linked<T, Alloc>::count() const
{
    return impl->count;
}

template< typename T , typename Alloc>
void ky_linked<T, Alloc>::assign(size_t inx, const T &x )
{
    replace(inx, x);
}
...
template< typename T , typename Alloc>
void ky_linked<T, Alloc>::replace(size_t i, const T &t)
{
    detach();
...
template< typename T , typename Alloc>
void ky_linked<T, Alloc>::move(size_t inx, size_t to)
{
    if (inx == to)
        return ;
...
template< typename T , typename Alloc>
void ky_linked<T, Alloc>::remove(size_t pos)
{
    detach();
...
template< typename T , typename Alloc>
void ky_linked<T, Alloc>::swap(size_t i, size_t j)
{
    detach();

    list_node *x = (this->begin() +ky_bound(size_t(0), ky_min(i, j), size()-1)).ope;
    list_node *y = (this->begin() +ky_bound(size_t(0), ky_max(i, j), size()-1)).ope;
    if (x == y)
        return ;
