...
template <typename T >
ky_vector<T>::ky_vector(size_t count):
    VecBase()
{
...
template <typename T >
void ky_vector<T>::insert(iterator pos, size_t count, const T& v)
{
...
template <typename T >
typename ky_vector<T>::iterator ky_vector<T>::insert(const_iterator pos, size_t count, const T& v)
{
    VecBase::fill(v, count, pos.ope - begin().ope);
...
std::vector<T> ky_vector<T>::to_std()
{
    ...
    ky_mem()->copy(dat.data(), VecBase::data(), VecBase::bytecount());
    return dat;
}
template <typename T >
void ky_vector<T>::form(const std::vector<T> &rhs)
{
    ...
    ky_mem()->copy(VecBase::data(), rhs.data(), VecBase::bytecount());
}
template <typename T >
...
template <typename T >
size_t ky_vector<T>::count()const
{
    return VecBase::size();
}
...
template <typename T >
ky_vector<T> &ky_vector<T>::append(const T *s, size_t len)
{
...
template <typename T >
ky_vector<T> &ky_vector<T>::insert(size_t i, T c)
{
    return *(ky_vector<T>*)&VecBase::insert(i, c);
}
template <typename T >
ky_vector<T> &ky_vector<T>::insert(size_t i, const T *s, size_t len)
{
    return *(ky_vector<T>*)&VecBase::insert(i, s, len);
}
template <typename T >
ky_vector<T> &ky_vector<T>::insert(size_t i, const ky_vector<T> &a)
{
    return *(ky_vector<T>*)&VecBase::insert(i, a);
}

template <typename T >
void ky_vector<T>::remove(size_t index, size_t len)
{
    remove(index, len);
}

template <typename T >
ky_vector<T> &ky_vector<T>::replace(size_t index, size_t len, const T *s, size_t alen)
{
    return *(ky_vector<T>*)&VecBase::replace(index, len, s, alen);
}
template <typename T >
ky_vector<T> &ky_vector<T>::replace(size_t index, size_t len, const ky_vector<T> &s)
{
