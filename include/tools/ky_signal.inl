...
class sigslot
{
    ky_list<intptr_t> list_slot;
    ky_list<int> list_count;

    typedef typename ky_list<intptr_t>::iterator sIterator;
    typedef typename ky_list<int>::iterator cIterator;
public:
    typedef sIterator slots;

#define ParamCount 0
public:
    template<typename X, typename Y , typename Ret>
    inline slots connect(Signal<Ret ()> *sig, Y* x,
                        Ret (X::*func)() const)
    {
        sig->connect(x, func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
        {
            if (*ite == (intptr_t)(sig))
                return ite;
        }
        list_slot.push_back ((intptr_t)(sig));
        list_count.push_back (ParamCount);
        return --list_slot.end ();
    }
    template< typename X, typename Y , typename Ret>
    inline slots connect(Signal<Ret ()> *sig, Y* x,
                 Ret (X::*func)())
    ...
    template<typename Ret>
    inline slots connect(Signal<Ret ()> *sig,
                 Ret (*func)())
    {
        sig->connect(func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template< typename X, typename Y , typename Ret>
    inline void disconnect(Signal<Ret ()> *sig, Y* x,
                    Ret (X::*func)() const)
    {
        sig->disconnect(x, func);
        if (sig->is_empty())
        {
            sIterator site = list_slot.begin ();
            cIterator cite = list_count.begin ();
            for (; site != list_slot.end () && cite != list_count.end (); ++site, ++cite)
            {
                if (*site == (intptr_t)sig)
                {
                    list_slot.erase (site);
                    list_count.erase (cite);
                }
            }
        }
    }
    ...
    template<typename Ret>
    inline void disconnect(Signal<Ret ()> *sig,
                    Ret (*func)())
    {
        sig->disconnect(func);
        if (sig->is_empty())
    ...
    inline void emit (slots s)
    {
        sIterator site = list_slot.begin ();
        cIterator cite = list_count.begin ();
        for (; site != list_slot.end() && cite != list_count.end (); ++site, ++cite)
        {
            if (*cite == ParamCount && s == site)
            {
                Signal<Ret ()> * oj = (Signal<Ret ()> *)(*site);
                oj->emit();
            }
        }
    }
...
public:
    ...
    inline slots connect(Signal<Ret (Param0)> *sig, Y* x,
    ...
    template<typename Ret, typename Param0>
    inline slots connect(Signal<Ret (Param0)> *sig,
                 Ret (*func)(Param0))
    {
        sig->connect(func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template< typename X, typename Y , typename Ret, typename Param0>
    inline void disconnect(Signal<Ret (Param0)> *sig, Y* x,
                    Ret (X::*func)(Param0) const)
    {
        sig->disconnect(x, func);
        if (sig->is_empty())
    ...
    template<typename Ret, typename Param0>
    inline void disconnect(Signal<Ret (Param0)> *sig,
                    Ret (*func)(Param0))
    {
        sig->disconnect(func);
        if (sig->is_empty())
    ...
    inline void emit (slots s, Param0 p0)
    {
        sIterator site = list_slot.begin ();
        cIterator cite = list_count.begin ();
        for (; site != list_slot.end() && cite != list_count.end (); ++site, ++cite)
        {
            if (*cite == ParamCount && site == s)
            {
                Signal<Ret (Param0)> * oj = (Signal<Ret (Param0)> *)(*site);
                oj->emit(p0);
            }
        }
    }
...
public:
    ...
    inline slots connect(Signal<Ret (Param0, Param1)> *sig, Y* x,
    ...
    template<typename Ret, typename Param0, typename Param1>
    inline slots connect(Signal<Ret (Param0, Param1)> *sig,
    ...
    template< typename X, typename Y , typename Ret, typename Param0, typename Param1>
    inline void disconnect(Signal<Ret (Param0,Param1)> *sig, Y* x,
                    Ret (X::*func)(Param0,Param1) const)
    {
        sig->disconnect(x, func);
        if (sig->is_empty())
    ...
    template<typename Ret, typename Param0, typename Param1>
    inline void disconnect(Signal<Ret (Param0, Param1)> *sig,
                    Ret (*func)(Param0, Param1))
    {
        sig->disconnect(func);
        if (sig->is_empty())
    ...
    inline void emit (slots s, Param0 p0, Param1 p1)
    {
        sIterator site = list_slot.begin ();
        cIterator cite = list_count.begin ();
        for (; site != list_slot.end() && cite != list_count.end (); ++site, ++cite)
        {
            if (*cite == ParamCount && site == s)
            {
                Signal<Ret (Param0, Param1)> * oj = (Signal<Ret (Param0, Param1)> *)(*site);
                oj->emit(p0, p1);
            }
        }
    }
...
public:
    template<typename X, typename Y , typename Ret, typename Param0, typename Param1,
             typename Param2>
    inline slots connect(Signal<Ret (Param0, Param1, Param2)> *sig, Y* x,
                        Ret (X::*func)(Param0, Param1, Param2) const)
    {
        sig->connect(x, func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template<typename Ret, typename Param0, typename Param1, typename Param2>
    inline slots connect(Signal<Ret (Param0, Param1, Param2)> *sig,
                 Ret (*func)(Param0, Param1, Param2))
    {
        sig->connect(func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template< typename X, typename Y , typename Ret, typename Param0, typename Param1,
              typename Param2>
    inline void disconnect(Signal<Ret (Param0,Param1,Param2)> *sig, Y* x,
                    Ret (X::*func)(Param0,Param1,Param2) const)
    {
        sig->disconnect(x, func);
        if (sig->is_empty())
    ...
    template<typename Ret, typename Param0, typename Param1, typename Param2>
    inline void disconnect(Signal<Ret (Param0, Param1, Param2)> *sig,
                    Ret (*func)(Param0, Param1, Param2))
    {
        sig->disconnect(func);
        if (sig->is_empty())
    ...
    inline void emit (slots s, Param0 p0, Param1 p1, Param2 p2)
    {
        sIterator site = list_slot.begin ();
        cIterator cite = list_count.begin ();
        for (; site != list_slot.end() && cite != list_count.end (); ++site, ++cite)
        {
            if (*cite == ParamCount && s == site)
            {
                Signal<Ret (Param0, Param1,Param2)> * oj =
                        (Signal<Ret (Param0, Param1, Param2)> *)(*site);
                oj->emit(p0, p1, p2);
            }
        }
    }
...
public:
    ...
    inline slots connect(Signal<Ret (Param0, Param1, Param2, Param3)> *sig, Y* x,
                        Ret (X::*func)(Param0, Param1, Param2, Param3) const)
    {
        sig->connect(x, func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template<typename Ret, typename Param0, typename Param1, typename Param2, typename Param3>
    inline slots connect(Signal<Ret (Param0, Param1, Param2,Param3)> *sig,
                 Ret (*func)(Param0, Param1, Param2,Param3))
    {
        sig->connect(func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template< typename X, typename Y , typename Ret, typename Param0, typename Param1,
              typename Param2, typename Param3>
    inline void disconnect(Signal<Ret (Param0,Param1,Param2,Param3)> *sig, Y* x,
                    Ret (X::*func)(Param0,Param1,Param2,Param3) const)
    {
        sig->disconnect(x, func);
        if (sig->is_empty())
    ...
    template<typename Ret, typename Param0, typename Param1, typename Param2, typename Param3>
    inline void disconnect(Signal<Ret (Param0, Param1, Param2,Param3)> *sig,
                    Ret (*func)(Param0, Param1, Param2,Param3))
    {
        sig->disconnect(func);
        if (sig->is_empty())
    ...
    inline void emit (slots s, Param0 p0, Param1 p1, Param2 p2, Param3 p3)
    {
        sIterator site = list_slot.begin ();
        cIterator cite = list_count.begin ();
        for (; site != list_slot.end() && cite != list_count.end (); ++site, ++cite)
        {
            if (*cite == ParamCount && s == site)
            {
                Signal<Ret (Param0, Param1,Param2,Param3)> * oj =
                        (Signal<Ret (Param0, Param1, Param2,Param3)> *)(*site);
                oj->emit(p0, p1, p2, p3);
            }
        }
    }
...
public:
    ...
    inline slots connect(Signal<Ret (Param0, Param1, Param2, Param3,Param4)> *sig, Y* x,
                        Ret (X::*func)(Param0, Param1, Param2, Param3,Param4) const)
    {
        sig->connect(x, func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template<typename Ret, typename Param0, typename Param1, typename Param2, typename Param3,
             typename Param4>
    inline slots connect(Signal<Ret (Param0, Param1, Param2,Param3,Param4)> *sig,
                 Ret (*func)(Param0, Param1, Param2,Param3,Param4))
    {
        sig->connect(func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template< typename X, typename Y , typename Ret, typename Param0, typename Param1,
              typename Param2, typename Param3, typename Param4>
    inline void disconnect(Signal<Ret (Param0,Param1,Param2,Param3,Param4)> *sig, Y* x,
                    Ret (X::*func)(Param0,Param1,Param2,Param3,Param4) const)
    {
        sig->disconnect(x, func);
        if (sig->is_empty())
    ...
    template<typename Ret, typename Param0, typename Param1, typename Param2, typename Param3,
             typename Param4>
    inline void disconnect(Signal<Ret (Param0, Param1, Param2,Param3,Param4)> *sig,
                    Ret (*func)(Param0, Param1, Param2,Param3,Param4))
    {
        sig->disconnect(func);
        if (sig->is_empty())
    ...
    inline void emit (slots s, Param0 p0, Param1 p1, Param2 p2, Param3 p3, Param4 p4)
    {
        sIterator site = list_slot.begin ();
        cIterator cite = list_count.begin ();
        for (; site != list_slot.end() && cite != list_count.end (); ++site, ++cite)
        {
            if (*cite == ParamCount && s == site)
            {
                Signal<Ret (Param0, Param1,Param2,Param3,Param4)> * oj =
                        (Signal<Ret (Param0, Param1, Param2,Param3,Param4)> *)(*site);
                oj->emit(p0, p1, p2, p3, p4);
            }
        }
    }
#undef ParamCount
...
public:
    ...
    inline slots connect(Signal<Ret (Param0, Param1, Param2, Param3,Param4,Param5)> *sig, Y* x,
                        Ret (X::*func)(Param0, Param1, Param2, Param3,Param4,Param5) const)
    {
        sig->connect(x, func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    inline slots connect(Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5)> *sig,
                 Ret (*func)(Param0, Param1, Param2,Param3,Param4,Param5))
    {
        sig->connect(func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template< typename X, typename Y , typename Ret, typename Param0, typename Param1,
              typename Param2, typename Param3, typename Param4, typename Param5>
    inline void disconnect(Signal<Ret (Param0,Param1,Param2,Param3,Param4,Param5)> *sig, Y* x,
                    Ret (X::*func)(Param0,Param1,Param2,Param3,Param4,Param5) const)
    {
        sig->disconnect(x, func);
        if (sig->is_empty())
    ...
    template<typename Ret, typename Param0, typename Param1, typename Param2, typename Param3,
             typename Param4, typename Param5>
    inline void disconnect(Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5)> *sig,
                    Ret (*func)(Param0, Param1, Param2,Param3,Param4,Param5))
    {
        sig->disconnect(func);
        if (sig->is_empty())
    ...
    inline void emit (slots s, Param0 p0, Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)
    {
        sIterator site = list_slot.begin ();
        cIterator cite = list_count.begin ();
        for (; site != list_slot.end() && cite != list_count.end (); ++site, ++cite)
        {
            if (*cite == ParamCount && s == site)
            {
                Signal<Ret (Param0, Param1,Param2,Param3,Param4,Param5)> * oj =
                        (Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5)> *)(*site);
                oj->emit(p0, p1, p2, p3, p4, p5);
            }
        }
    }
#undef ParamCount
...
public:
    ...
    inline slots connect(Signal<Ret (Param0, Param1, Param2, Param3,Param4,Param5,Param6)> *sig, Y* x,
                        Ret (X::*func)(Param0, Param1, Param2, Param3,Param4,Param5,Param6) const)
    {
        sig->connect(x, func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    inline slots connect(Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5,Param6)> *sig,
                 Ret (*func)(Param0, Param1, Param2,Param3,Param4,Param5,Param6))
    {
        sig->connect(func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template< typename X, typename Y , typename Ret, typename Param0, typename Param1,
              typename Param2, typename Param3, typename Param4, typename Param5, typename Param6>
    inline void disconnect(Signal<Ret (Param0,Param1,Param2,Param3,Param4,Param5,Param6)> *sig, Y* x,
                    Ret (X::*func)(Param0,Param1,Param2,Param3,Param4,Param5,Param6) const)
    {
        sig->disconnect(x, func);
        if (sig->is_empty())
    ...
    template<typename Ret, typename Param0, typename Param1, typename Param2, typename Param3,
             typename Param4, typename Param5, typename Param6>
    inline void disconnect(Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5,Param6)> *sig,
                    Ret (*func)(Param0, Param1, Param2,Param3,Param4,Param5,Param6))
    {
        sig->disconnect(func);
        if (sig->is_empty())
    ...
    inline void emit (slots s, Param0 p0, Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6)
    {
        sIterator site = list_slot.begin ();
        cIterator cite = list_count.begin ();
        for (; site != list_slot.end() && cite != list_count.end (); ++site, ++cite)
        {
            if (*cite == ParamCount && s == site)
            {
                Signal<Ret (Param0, Param1,Param2,Param3,Param4,Param5,Param6)> * oj =
                        (Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5,Param6)> *)(*site);
                oj->emit(p0, p1, p2, p3, p4, p5, p6);
            }
        }
    }
...
public:
    ...
    inline slots connect(Signal<Ret (Param0, Param1, Param2, Param3,Param4,Param5,Param6,Param7)> *sig, Y* x,
                        Ret (X::*func)(Param0, Param1, Param2, Param3,Param4,Param5,Param6,Param7) const)
    {
        sig->connect(x, func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    inline slots connect(Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5,Param6,Param7)> *sig,
                 Ret (*func)(Param0, Param1, Param2,Param3,Param4,Param5,Param6,Param7))
    {
        sig->connect(func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template< typename X, typename Y , typename Ret, typename Param0, typename Param1,
              typename Param2, typename Param3, typename Param4, typename Param5,
              typename Param6, typename Param7>
    inline void disconnect(Signal<Ret (Param0,Param1,Param2,Param3,Param4,Param5,Param6,Param7)> *sig, Y* x,
                    Ret (X::*func)(Param0,Param1,Param2,Param3,Param4,Param5,Param6,Param7) const)
    {
        sig->disconnect(x, func);
        if (sig->is_empty())
    ...
    template<typename Ret, typename Param0, typename Param1, typename Param2, typename Param3,
             typename Param4, typename Param5, typename Param6, typename Param7>
    inline void disconnect(Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5,Param6,Param7)> *sig,
                    Ret (*func)(Param0, Param1, Param2,Param3,Param4,Param5,Param6,Param7))
    {
        sig->disconnect(func);
        if (sig->is_empty())
    ...
    template<typename Param0, typename Param1, typename Param2, typename Param3,
             typename Param4, typename Param5, typename Param6, typename Param7,
             typename Ret = void>
    inline void emit (slots s, Param0 p0, Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7)
    {
        sIterator site = list_slot.begin ();
        cIterator cite = list_count.begin ();
        for (; site != list_slot.end() && cite != list_count.end (); ++site, ++cite)
        {
            if (*cite == ParamCount && s == site)
            {
                Signal<Ret (Param0, Param1,Param2,Param3,Param4,Param5,Param6,Param7)> * oj =
                        (Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5,Param6,Param7)> *)(*site);
                oj->emit(p0, p1, p2, p3, p4, p5, p6, p7);
            }
        }
    }
#undef ParamCount
...
public:
    ...
    inline slots connect(Signal<Ret (Param0, Param1, Param2, Param3,Param4,Param5,Param6,Param7,Param8)> *sig, Y* x,
                        Ret (X::*func)(Param0, Param1, Param2, Param3,Param4,Param5,Param6,Param7,Param8) const)
    {
        sig->connect(x, func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    inline slots connect(Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5,Param6,Param7,Param8)> *sig,
                 Ret (*func)(Param0, Param1, Param2,Param3,Param4,Param5,Param6,Param7,Param8))
    {
        sig->connect(func);
        for (typename ky_list<intptr_t>::iterator ite = list_slot.begin(); ite != list_slot.end(); ++ite)
    ...
    template< typename X, typename Y , typename Ret, typename Param0, typename Param1,
              typename Param2, typename Param3, typename Param4, typename Param5,
              typename Param6, typename Param7, typename Param8>
    inline void disconnect(Signal<Ret (Param0,Param1,Param2,Param3,Param4,Param5,Param6,Param7,Param8)> *sig, Y* x,
                    Ret (X::*func)(Param0,Param1,Param2,Param3,Param4,Param5,Param6,Param7,Param8) const)
    {
        sig->disconnect(x, func);
        if (sig->is_empty())
    ...
    template<typename Ret, typename Param0, typename Param1, typename Param2, typename Param3,
             typename Param4, typename Param5, typename Param6, typename Param7, typename Param8>
    inline void disconnect(Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5,Param6,Param7,Param8)> *sig,
                    Ret (*func)(Param0, Param1, Param2,Param3,Param4,Param5,Param6,Param7,Param8))
    {
        sig->disconnect(func);
        if (sig->is_empty())
               ...
               Param6 p6, Param7 p7, Param8 p8)
    {
        ...
        for (; site != list_slot.end() && cite != list_count.end (); ++site, ++cite)
        {
            if (*cite == ParamCount && s == site)
            {
                Signal<Ret (Param0, Param1,Param2,Param3,Param4,Param5,Param6,Param7,Param8)> * oj =
                        (Signal<Ret (Param0, Param1, Param2,Param3,Param4,Param5,Param6,Param7,Param8)> *)(*site);
                oj->emit(p0, p1, p2, p3, p4, p5, p6, p7, p8);
            }
        }
    }
