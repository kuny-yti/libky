...
public:
    ...
    //!
    ky_image(int w, int h, int d, eImagePixels f, uchar *md = 0, eImageFlags flag = Image_Not);
    ky_image(int w, int h, eImagePixels f, uchar *md = 0, eImageFlags flag = Image_Not);
    ky_image(const isize3 &dim, eImagePixels f, uchar *md = 0, eImageFlags flag = Image_Not);
    ...
    ky_image(uchar *data, size_t dlen, eImageFormats rforms );
    ...
    //! \return
    //!
    size_t byte()const{return bytecount ();}
...
public:
    ...
    bool load(uchar *data, size_t dlen, eImageFormats form  = Image_PNG) ;
    //!
    ...
    bool save(uchar **data, size_t *dlen, eImageFormats form = Image_PNG) ;
